...
if(payBtn){
    payBtn.addEventListener('click', function(){
        ...
        if(!method){
            ...
            return;
>>>>>>> 12281f25f0360d9e157f6004abf30cac9d92c79e
        }
            ...
            <div class="pos-layout">
                ...
                <div>
                    ...
                    <div class="footer">
                        ...
                        @if($order->payment_status === 'paid')
                            <a href="{{ route('orders.receipt', $order->orderid) }}" class="btn btn-receipt">ดูใบเสร็จ</a>
                        @endif
                    </div>
                ...
                <div>
                    <div class="payment-card">
                        ...
                        @if($order->payment_status === 'pending')
                            ...
                            {{-- ===== ฟอร์มชำระเงิน ===== --}}
                            <form id="payForm" action="{{ route('orders.pay', $order->orderid) }}" method="POST">
                                @csrf
                                ...
                                <div class="input-group">
                                    <label>รับเงินมา</label>
                                    <input type="number" id="received" name="received_amount" step="0.01" placeholder="0.00"
                                        required>
                                </div>
                                ...
                                <button type="button" id="payBtn" class="btn-action btn-success">
                                    ยืนยันการชำระเงิน
                                </button>
                            ...
                            {{-- ===== ฟอร์มยกเลิก ===== --}}
                            <form id="cancelForm" action="{{ route('orders.cancel', $order->orderid) }}" method="POST">
                                @csrf
                            </form>

                            <button type="button" id="cancelBtn" class="btn-action btn-danger">
                                ยกเลิกคำสั่งซื้อ
                            </button>
